 ...
 * @author mist
 */
public class MySimpleUsernamePasswordLoginModule extends
	...
	protected boolean validatePassword(String inputPassword,
		...
		return true;
		// return super.validatePassword(encryptedInputPassword,
		// expectedPassword);
	}
	...
	protected Group[] getRoleSets() throws LoginException {
		...
		try {
			group.addMember(new SimplePrincipal("say-hello"));
		} catch (Exception e) {
